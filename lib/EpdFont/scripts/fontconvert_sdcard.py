...
INTERVAL_PRESETS = {
    ...
    # Thai: ASCII Latin + basic punctuation/superscripts + Thai block (consonants,
    # vowels, tone marks). Intentionally narrow to keep .cpfont files small.
    "thai":        [(0x0020, 0x007E), (0x00A0, 0x00FF), (0x0E00, 0x0E7F),
                    (0x2010, 0x2027), (0x2030, 0x203A), (0x2070, 0x209F)],
