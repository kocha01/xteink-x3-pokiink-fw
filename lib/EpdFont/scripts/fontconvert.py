...
parser.add_argument("--advance-y", dest="advance_y", type=int, default=None, help="Override the line-advance (advanceY) in pixels. Defaults to the font's natural metrics height. Use this to tighten Thai/CJK fonts whose face metrics include extra leading for combining marks.")
...
advance_y_value = args.advance_y if args.advance_y is not None else norm_ceil(metrics_face.size.height)
