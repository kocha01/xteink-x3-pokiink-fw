...
std::string Txt::getCoverBmpPath() const {
  const auto sizeSuffix = "_" + std::to_string(BoardConfig::Display::kLogicalPortraitWidth) + "x" +
                          std::to_string(BoardConfig::Display::kLogicalPortraitHeight);
  return cachePath + "/cover" + sizeSuffix + ".bmp";
}
