...
#ifndef CROSSPOINT_SD_CS
#define CROSSPOINT_SD_CS 12
#endif

#ifndef CROSSPOINT_SD_SPI_FQ
#define CROSSPOINT_SD_SPI_FQ 40000000UL
#endif

#ifndef CROSSPOINT_SD_HAS_POWER_SWITCH
#define CROSSPOINT_SD_HAS_POWER_SWITCH 0
#endif

#if CROSSPOINT_SD_HAS_POWER_SWITCH
#ifndef CROSSPOINT_SD_POWER_CONTROL_PIN
#error "CROSSPOINT_SD_POWER_CONTROL_PIN must be defined when CROSSPOINT_SD_HAS_POWER_SWITCH=1"
#endif

#ifndef CROSSPOINT_SD_POWER_ON_LEVEL
#define CROSSPOINT_SD_POWER_ON_LEVEL 1
#endif

#ifndef CROSSPOINT_SD_POWER_SETTLE_MS
#define CROSSPOINT_SD_POWER_SETTLE_MS 20
#endif
#endif

namespace {
constexpr uint8_t SD_CS = CROSSPOINT_SD_CS;
constexpr uint32_t SPI_FQ = CROSSPOINT_SD_SPI_FQ;

#if CROSSPOINT_SD_HAS_POWER_SWITCH
void enableSdPower() {
  pinMode(CROSSPOINT_SD_POWER_CONTROL_PIN, OUTPUT);
  digitalWrite(CROSSPOINT_SD_POWER_CONTROL_PIN, CROSSPOINT_SD_POWER_ON_LEVEL ? HIGH : LOW);
