...
class SettingsActivity final : public Activity {
  enum class ViewMode { CategoryHome, CategorySettings };
  ...
  int settingsCount = 0;
  ViewMode currentView = ViewMode::CategoryHome;
  std::array<int, 4> selectedSettingIndexByCategory = {0, 0, 0, 0};
  ...
  std::string getCategorySummary(int categoryIndex) const;
  std::string getSettingValueText(const SettingInfo& setting) const;
