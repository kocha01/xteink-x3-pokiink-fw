...
constexpr NetworkMode kVisibleModes[MENU_ITEM_COUNT] = {
    NetworkMode::JOIN_NETWORK,
    NetworkMode::CONNECT_CALIBRE,
    NetworkMode::CREATE_HOTSPOT,
};
constexpr StrId menuItems[MENU_ITEM_COUNT] = {
    StrId::STR_JOIN_NETWORK,
    StrId::STR_CALIBRE_WIRELESS,
    StrId::STR_CREATE_HOTSPOT,
};
constexpr StrId menuDescs[MENU_ITEM_COUNT] = {
    StrId::STR_JOIN_DESC,
    StrId::STR_CALIBRE_DESC,
    StrId::STR_HOTSPOT_DESC,
};
constexpr UIIcon menuIcons[MENU_ITEM_COUNT] = {
    UIIcon::Wifi,
    UIIcon::Library,
    UIIcon::Hotspot,
};
...
void NetworkModeSelectionActivity::loop() {
  ...
  if (mappedInput.wasPressed(MappedInputManager::Button::Confirm)) {
    onModeSelected(kVisibleModes[selectedIndex]);
    return;
  }
...
void NetworkModeSelectionActivity::render(RenderLock&&) {
  ...
  GUI.drawHeader(renderer, Rect{0, metrics.topPadding, pageWidth, metrics.headerHeight}, tr(STR_SYNC_APP));
