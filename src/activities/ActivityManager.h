...
class ActivityManager {
 ...
 public:
  ...
  void goToSleep();
  // X3 light-sleep variant: push SleepActivity on top of currentActivity
  // (keeps HomeActivity/ReaderActivity alive in memory so wake can pop back without rebuilding).
  void pushToSleep();
  void goToBoot();
