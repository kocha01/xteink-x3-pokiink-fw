...
class EpubReaderMenuActivity final : public Activity {
 public:
  ...
  explicit EpubReaderMenuActivity(GfxRenderer& renderer, MappedInputManager& mappedInput, const std::string& title,
                                  ...
                                  const std::string& currentSdFontFamilyName = std::string{});
 ...
 private:
  ...
  // When non-empty, the user has selected a discovered SD card font family;
  // this takes precedence over pendingFontFamily until cleared back to "".
  // Synced into SETTINGS.sdFontFamilyName via MenuResult on exit.
  std::string pendingSdFontFamilyName;
