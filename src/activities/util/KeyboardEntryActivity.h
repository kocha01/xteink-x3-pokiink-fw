...
class KeyboardEntryActivity : public Activity {
 ...
 private:
  ...
  // Thai layouts — 3 styles sharing the same row lengths.
  // Style 0: Alphabetical (ก-ฮ consonants on page 1, vowels/marks on page 2)
  static const char* const thaiKeysAlpha[NUM_ROWS][KEYS_PER_ROW];
  static const char* const thaiKeysAlphaShift[NUM_ROWS][KEYS_PER_ROW];
  // Style 1: Kedmanee (follows standard Thai computer keyboard layout)
  static const char* const thaiKeysKed[NUM_ROWS][KEYS_PER_ROW];
  static const char* const thaiKeysKedShift[NUM_ROWS][KEYS_PER_ROW];
  // Style 2: Frequency (most common chars first, optimized for 5-button nav)
  static const char* const thaiKeysFreq[NUM_ROWS][KEYS_PER_ROW];
  static const char* const thaiKeysFreqShift[NUM_ROWS][KEYS_PER_ROW];
